...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-monitor/node_modules/monitor/lib/probes/SyncProbe.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-monitor/node_modules/monitor/lib/probes/SyncProbe.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-monitor/node_modules/monitor/lib/probes/</a> &#187; SyncProbe.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// SyncProbe.js (c) 2010-2014 Loren West and other contributors
...
<span class="cstat-no" title="statement not covered" >      var className = t.get('className'),</span>
          config = SyncProbe.Config,
          probeClassName = config.classMap[className] || config.defaultProbe,
          probeClass = SyncProbe[probeClassName];
<span class="cstat-no" title="statement not covered" >      _.each(_.functions(probeClass.prototype), <span class="fstat-no" title="function not covered" >function(methodName) {</span></span>
<span class="cstat-no" title="statement not covered" >        t[methodName] = probeClass.prototype[methodName];</span>
      });
<span class="cstat-no" title="statement not covered" >      t.probeClass = probeClass.prototype.probeClass;</span>
&nbsp;
      // Forward class initialization to the coerced initialize method
<span class="cstat-no" title="statement not covered" >      return t.initialize.apply(t, arguments);</span>
    },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      callback({msg: 'not implemented'});</span>
    },
&nbsp;
    /**
