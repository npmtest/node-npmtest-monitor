...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-monitor/node_modules/monitor/lib/Monitor.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-monitor/node_modules/monitor/lib/Monitor.js</span></h1>
    <h2>
        
        Statements: <span class="metric">20.24% <small>(34 / 168)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">5.66% <small>(6 / 106)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">13.89% <small>(5 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">20.61% <small>(34 / 165)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-monitor/node_modules/monitor/lib/</a> &#187; Monitor.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  var commonJS = (typeof exports !== 'undefined'),
      Backbone = commonJS ? require('backbone') : <span class="branch-1 cbranch-no" title="branch not covered" >root.Backbone,</span>
      _ = commonJS ? require('underscore')._ : <span class="branch-1 cbranch-no" title="branch not covered" >root._,</span>
      log = null, stat = null,
      autoStartedMonitors = [],
      Cron = commonJS ? require('cron') : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
&nbsp;
  // Constants
...
<span class="cstat-no" title="statement not covered" >      log.info('init', params);</span>
    },
&nbsp;
    /**
    ...
    * @event connect
    */
    connect: <span class="fstat-no" title="function not covered" >function(callback) {</span>
<span class="cstat-no" title="statement not covered" >      var t = this, startTime = Date.now();</span>
<span class="cstat-no" title="statement not covered" >      Monitor.getRouter().connectMonitor(t, <span class="fstat-no" title="function not covered" >function(error) {</span></span>
&nbsp;
        // Monitor changes to writable attributes
<span class="cstat-no" title="statement not covered" >        if (!error &amp;&amp; t.get('writableAttributes').length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >          t.on('change', t.onChange, t);</span>
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          t.trigger('connect', t);</span>
<span class="cstat-no" title="statement not covered" >          t.trigger('change', t);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          log.info('connected', {initParams: t.get('initParams'), probeId: t.get('probeId')});</span>
<span class="cstat-no" title="statement not covered" >          stat.time('connect', Date.now() - startTime);</span>
        }
      });
    },
&nbsp;
    ...
    */
    getConnection: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >      var t = this;</span>
<span class="cstat-no" title="statement not covered" >      return (t.probe &amp;&amp; t.probe.connection ? t.probe.connection : null);</span>
    },
&nbsp;
    /**
    ...
    */
    isConnected: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >      var t = this;</span>
<span class="cstat-no" title="statement not covered" >      return (t.probe != null);</span>
    },
&nbsp;
    /**
    ...
    * &lt;/ul&gt;
    */
    disconnect: <span class="fstat-no" title="function not covered" >function(callback) {</span>
<span class="cstat-no" title="statement not covered" >      var t = this,</span>
...
<span class="cstat-no" title="statement not covered" >      t.off('change', t.onChange, t);</span>
&nbsp;
      // Disconnect from the router
<span class="cstat-no" title="statement not covered" >      Monitor.getRouter().disconnectMonitor(t, reason, <span class="fstat-no" title="function not covered" >function(error, reason) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (callback) {<span class="cstat-no" title="statement not covered" >callback(error);}</span></span>
<span class="cstat-no" title="statement not covered" >        if (error) {</span>
<span class="cstat-no" title="statement not covered" >          log.error('disconnect', {error: error});</span>
        }
        else {
<span class="cstat-no" title="statement not covered" >          t.trigger('disconnect', reason);</span>
<span class="cstat-no" title="statement not covered" >          log.info('disconnected', {reason: reason, probeId: probeId});</span>
<span class="cstat-no" title="statement not covered" >          stat.time('disconnect', Date.now() - startTime);</span>
        }
      });
    },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var probeAttrs = t.toProbeJSON();</span>
<span class="cstat-no" title="statement not covered" >      delete probeAttrs.id;</span>
<span class="cstat-no" title="statement not covered" >      for (var attrName in probeAttrs) {</span>
<span class="cstat-no" title="statement not covered" >        var isWritable = writableAttributes === '*' || writableAttributes.indexOf(attrName) &gt;= 0;</span>
<span class="cstat-no" title="statement not covered" >        if (isWritable &amp;&amp; !(_.isEqual(t.attributes[attrName], t._probeValues[attrName]))) {</span>
<span class="cstat-no" title="statement not covered" >          writableChanges[attrName] = t.attributes[attrName];</span>
        }
      }
&nbsp;
      // Pass any writable changes on to control.set()
<span class="cstat-no" title="statement not covered" >      if (Monitor._.size(writableChanges)) {</span>
<span class="cstat-no" title="statement not covered" >        t.control('set', writableChanges, <span class="fstat-no" title="function not covered" >function(error) {</span></span>
<span class="cstat-no" title="statement not covered" >          if (error) {</span>
<span class="cstat-no" title="statement not covered" >            log.error('probeSet', 'Problem setting writable value', writableChanges, t.toMonitorJSON());</span>
          }
        });
      }
    },
&nbsp;
    ...
    * &lt;/ul&gt;
    */
    control: <span class="fstat-no" title="function not covered" >function(name, params, callback) {</span>
<span class="cstat-no" title="statement not covered" >      var t = this,</span>
          probe = t.probe,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var whenDone = <span class="fstat-no" title="function not covered" >function(error, args) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (error) {</span>
<span class="cstat-no" title="statement not covered" >          log.error(logId, error);</span>
        }
        else {
<span class="cstat-no" title="statement not covered" >          log.info('return.' + logId, args);</span>
<span class="cstat-no" title="statement not covered" >          stat.time(logId, Date.now() - startTime);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (callback) {</span>
<span class="cstat-no" title="statement not covered" >          callback.apply(t, arguments);</span>
        }
      };
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!probe) {</span>
<span class="cstat-no" title="statement not covered" >        return whenDone('Probe not connected');</span>
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        probe.connection.emit('probe:control', {probeId: t.get('probeId'), name: name, params:params}, whenDone);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        probe.onControl(name, params, whenDone);</span>
      }
    },
&nbsp;
    /**
    ...
    */
    toProbeJSON: <span class="fstat-no" title="function not covered" >function(options) {</span>
<span class="cstat-no" title="statement not covered" >      var t = this,</span>
          json = {id: t.get('probeId')};
&nbsp;
      // Transfer all non-monitor attrs
<span class="cstat-no" title="statement not covered" >      _.each(t.toJSON(options), <span class="fstat-no" title="function not covered" >function(value, key) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (!(key in t.defaults)) {</span>
<span class="cstat-no" title="statement not covered" >          json[key] = value;</span>
        }
      });
...
&nbsp;
    ...
    */
    toMonitorJSON: <span class="fstat-no" title="function not covered" >function(options) {</span>
<span class="cstat-no" title="statement not covered" >      var t = this,</span>
          json = {};
&nbsp;
...
&nbsp;
    ...
    */
    toServerString: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >      return Monitor.toServerString(this.toMonitorJSON());</span>
    }
&nbsp;
  });
&nbsp;
...
&nbsp;
  ...
  */
  Monitor.generateUniqueId = <span class="fstat-no" title="function not covered" >function() {</span>
    // Generate a 4 digit random hex string
<span class="cstat-no" title="statement not covered" >    stat.increment('generateUniqueId');</span>
<span class="fstat-no" title="function not covered" >    function rhs4() {<span class="cstat-no" title="statement not covered" ></span>return (((1 + Math.random()) * 0x10000) | 0).toString(16).substring(1);}</span>
<span class="cstat-no" title="statement not covered" >    return (rhs4()+rhs4()+"-"+rhs4()+"-"+rhs4()+"-"+rhs4()+"-"+rhs4()+rhs4()+rhs4());</span>
  };
&nbsp;
  /**
  ...
  */
  Monitor.generateUniqueCollectionId = <span class="fstat-no" title="function not covered" >function(collection, prefix) {</span>
...
<span class="cstat-no" title="statement not covered" >    if (!collection.idSequence) {</span>
<span class="cstat-no" title="statement not covered" >      collection.idSequence = 0;</span>
<span class="cstat-no" title="statement not covered" >      collection.forEach(<span class="fstat-no" title="function not covered" >function(item){</span></span>
<span class="cstat-no" title="statement not covered" >        var id = item.get('id') || '',</span>
            sequence = +id.substr(prefix.length);
<span class="cstat-no" title="statement not covered" >        if (collection.idSequence &lt;= sequence) {</span>
<span class="cstat-no" title="statement not covered" >          collection.idSequence = sequence + 1;</span>
        }
      });
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return prefix + collection.idSequence++;</span>
  };
&nbsp;
  /**
  ...
  */
  Monitor.getRouter = <span class="fstat-no" title="function not covered" >function() {</span>
&nbsp;
    // Instantiate a router if no default
<span class="cstat-no" title="statement not covered" >    if (!Monitor.defaultRouter) {</span>
<span class="cstat-no" title="statement not covered" >      Monitor.defaultRouter = new Monitor.Router();</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      if (root.io) {</span>
<span class="cstat-no" title="statement not covered" >        Monitor.defaultRouter.setGateway({</span>
...
&nbsp;
    // Return the router
<span class="cstat-no" title="statement not covered" >    return Monitor.defaultRouter;</span>
  };
&nbsp;
  /**
  ...
  */
  Monitor.start = <span class="fstat-no" title="function not covered" >function(options, callback) {</span>
<span class="cstat-no" title="statement not covered" >    log.info('start', options);</span>
...
<span class="cstat-no" title="statement not covered" >    if (!Monitor.defaultServer) {</span>
<span class="cstat-no" title="statement not covered" >      Monitor.defaultServer = new Monitor.Server();</span>
<span class="cstat-no" title="statement not covered" >      Monitor.defaultServer.start(options, callback);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      callback();</span>
    }
<span class="cstat-no" title="statement not covered" >    return Monitor;</span>
  };
&nbsp;
  /**
  ...
  * @param callback {Function(error)} - Called when the server is accepting connections.
  */
  Monitor.stop = <span class="fstat-no" title="function not covered" >function(callback) {</span>
<span class="cstat-no" title="statement not covered" >    log.info('stop');</span>
<span class="cstat-no" title="statement not covered" >    callback = callback || <span class="fstat-no" title="function not covered" >function(){</span>};</span>
<span class="cstat-no" title="statement not covered" >    if (Monitor.defaultServer) {</span>
<span class="cstat-no" title="statement not covered" >      Monitor.defaultServer.stop(callback);</span>
<span class="cstat-no" title="statement not covered" >      delete Monitor.defaultServer;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      callback();</span>
    }
  };
&nbsp;
  ...
  * @return {String} A string representation of the monitor server
  */
  Monitor.toServerString = <span class="fstat-no" title="function not covered" >function(monitorJSON) {</span>
<span class="cstat-no" title="statement not covered" >    var str = monitorJSON.hostName;</span>
<span class="cstat-no" title="statement not covered" >    if (monitorJSON.appName) {</span>
<span class="cstat-no" title="statement not covered" >      str += ':' + monitorJSON.appName;</span>
<span class="cstat-no" title="statement not covered" >      if (monitorJSON.appInstance) {</span>
<span class="cstat-no" title="statement not covered" >        str += ':' + monitorJSON.appInstance;</span>
      }
    }
...
&nbsp;
  ...
  */
  Monitor.deepCopy = <span class="fstat-no" title="function not covered" >function(value, depth) {</span>
&nbsp;
    // Defaults
<span class="cstat-no" title="statement not covered" >    depth = typeof(depth) === 'undefined' ? DEFAULT_DEEP_COPY_DEPTH : depth;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    var strType = '[Object]';</span>
<span class="cstat-no" title="statement not covered" >    if (typeof value === 'function') {</span>
<span class="cstat-no" title="statement not covered" >      strType = '[Function]';</span>
    } else <span class="cstat-no" title="statement not covered" >if (Array.isArray(value)) {</span>
<span class="cstat-no" title="statement not covered" >      strType = '[Array]';</span>
    }
&nbsp;
    // Limit reached
<span class="cstat-no" title="statement not covered" >    if (depth &lt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >      return strType;</span>
    }
&nbsp;
    // Create a new object to copy into.
    // Proactively add constructor so it's at the top of a function
<span class="cstat-no" title="statement not covered" >    var copy = Array.isArray(value) ? [] : {};</span>
&nbsp;
    // Copy all elements (by reference)
<span class="cstat-no" title="statement not covered" >    for (var prop in value) {</span>
<span class="cstat-no" title="statement not covered" >      if (!value.hasOwnProperty || value.hasOwnProperty(prop)) {</span>
<span class="cstat-no" title="statement not covered" >        var elem = value[prop];</span>
<span class="cstat-no" title="statement not covered" >        if (typeof elem === 'object' || typeof elem === 'function') {</span>
<span class="cstat-no" title="statement not covered" >          copy[prop] = Monitor.deepCopy(elem, depth - 1);</span>
        }
        else {
<span class="cstat-no" title="statement not covered" >          copy[prop] = elem;</span>
        }
      }
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (typeof value === 'function') {</span>
<span class="cstat-no" title="statement not covered" >      if (_.isEmpty(copy)) {</span>
        // No sub-elements.  Identify it as a function.
<span class="cstat-no" title="statement not covered" >        copy = strType;</span>
      } else {
        // Sub-elements exist.  Identify it as a function by placing
        // a constructor at the top of the object
<span class="cstat-no" title="statement not covered" >        copy = _.extend({constructor: strType},copy);</span>
      }
    }
&nbsp;
    // Return the copy
...
&nbsp;
  ...
  */
  Monitor.stringify = <span class="fstat-no" title="function not covered" >function(value, depth, indent) {</span>
&nbsp;
    // Defaults
<span class="cstat-no" title="statement not covered" >    indent = typeof(indent) === 'undefined' ? 2 : indent;</span>
&nbsp;
    // Return a stringified depth-limited deep copy
<span class="cstat-no" title="statement not covered" >    return JSON.stringify(Monitor.deepCopy(value, depth), null, indent);</span>
  };
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >    Monitor.Config = {Monitor: defaultConfig};</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    root.Monitor = Monitor;</span>
  }
&nbsp;
  // Auto-start monitors after loading
  var autoStart = Monitor.Config.Monitor.autoStart;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (Monitor._.size(autoStart)) {
...
<span class="cstat-no" title="statement not covered" >      Monitor._.each(autoStart, <span class="fstat-no" title="function not covered" >function(model) {</span></span>
<span class="cstat-no" title="statement not covered" >        var autoStarted = new Monitor(model);</span>
<span class="cstat-no" title="statement not covered" >        autoStarted.connect(<span class="fstat-no" title="function not covered" >function(error) {</span></span>
<span class="cstat-no" title="statement not covered" >          if (error) {</span>
<span class="cstat-no" title="statement not covered" >            log.error('autoStart', 'Error auto-starting monitor', model, error);</span>
          }
<span class="cstat-no" title="statement not covered" >          autoStartedMonitors.push(autoStarted);</span>
        });
      });
    },0);
  }
