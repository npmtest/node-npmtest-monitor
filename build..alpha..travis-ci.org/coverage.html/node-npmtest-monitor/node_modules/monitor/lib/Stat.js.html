...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-monitor/node_modules/monitor/lib/Stat.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-monitor/node_modules/monitor/lib/Stat.js</span></h1>
    <h2>
        
        Statements: <span class="metric">72.88% <small>(43 / 59)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">44.83% <small>(13 / 29)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-monitor/node_modules/monitor/lib/</a> &#187; Stat.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/*jslint browser: true */
...
&nbsp;
  ...
  var Monitor = root.Monitor || require('./Monitor'),
      ...
      EventEmitter = Monitor.commonJS ? require('events').EventEmitter.prototype : <span class="branch-1 cbranch-no" title="branch not covered" >Monitor.Backbone.Events,</span>
      _ = Monitor._,
      emittingNow = false;
&nbsp;
&nbsp;
...
&nbsp;
  ...
  */
  proto.increment = function(name, value){
    value = _.isNumber(value) ? <span class="branch-0 cbranch-no" title="branch not covered" >value </span>: 1;
...
&nbsp;
  ...
  */
  proto.decrement = <span class="fstat-no" title="function not covered" >function(name, value){</span>
<span class="cstat-no" title="statement not covered" >    value = _.isNumber(value) ? value : 1;</span>
<span class="cstat-no" title="statement not covered" >    Stat._emit(this.module, name, value * -1, 'c');</span>
  };
&nbsp;
  /**
  ...
  */
  proto.gauge = <span class="fstat-no" title="function not covered" >function(name, value){</span>
<span class="cstat-no" title="statement not covered" >    Stat._emit(this.module, name, value, 'g');</span>
  };
&nbsp;
  /**
  ...
  */
  proto.time = <span class="fstat-no" title="function not covered" >function(name, duration){</span>
<span class="cstat-no" title="statement not covered" >    Stat._emit(this.module, name, duration, 'ms');</span>
  };
&nbsp;
  /**
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (emittingNow) {
...
<span class="cstat-no" title="statement not covered" >      if (!fullName) {</span>
<span class="cstat-no" title="statement not covered" >        fullName = module + '.' + name;</span>
      }
&nbsp;
      // Get the regex associated with the name
<span class="cstat-no" title="statement not covered" >      var regex = Stat.eventRegex[eventName];</span>
<span class="cstat-no" title="statement not covered" >      if (!regex) {</span>
<span class="cstat-no" title="statement not covered" >        regex = Stat.eventRegex[eventName] = Stat._buildRegex(eventName);</span>
      }
&nbsp;
      // Test the name with the regex, and emit if it matches
<span class="cstat-no" title="statement not covered" >      if (regex.test(fullName)) {</span>
<span class="cstat-no" title="statement not covered" >        Stat.emit(eventName, module, name, value, type);</span>
      }
    }
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (/^\/[^\/]*\/i*$/.test(str)) {
<span class="cstat-no" title="statement not covered" >      if (/i$/.test(str)) {</span>
<span class="cstat-no" title="statement not covered" >        modifier = 'i';</span>
<span class="cstat-no" title="statement not covered" >        str = str.replace(/i$/,'');</span>
      }
<span class="cstat-no" title="statement not covered" >      regexStr = '^' + str.replace(/^\//,'').replace(/\/$/,'') + '$';</span>
    }
&nbsp;
      ...
      for (var i = 0, l = str.length; i &lt; l; i++) {
        ...
        switch (c) {
          case '.':
            ...
            break;
          case '*':
            c = (i === lastIdx ? '.*' : <span class="branch-1 cbranch-no" title="branch not covered" >'[^\\.]*')</span>;
            break;
          case '{':
            c = '(';
            inSquiggly = true;
          ...
          case '}':
            ...
            break;
          case ',':
            <span class="missing-if-branch" title="else path not taken" >E</span>if (inSquiggly) {
              c = '|';
            }
            break;
        }
