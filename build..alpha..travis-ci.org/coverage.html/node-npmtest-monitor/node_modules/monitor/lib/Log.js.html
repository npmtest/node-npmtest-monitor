...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-monitor/node_modules/monitor/lib/Log.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-monitor/node_modules/monitor/lib/Log.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">60% <small>(27 / 45)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-monitor/node_modules/monitor/lib/</a> &#187; Log.js</div>
</div>
<div class="body">
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!regex) {
        regex = Log.eventRegex[eventName] = Stat._buildRegex(eventName);
      }
&nbsp;
      // Test the long name with the regex, and emit if it matches
      <span class="missing-if-branch" title="if path not taken" >I</span>if (regex.test(fullName)) {
&nbsp;
        // Build the arguments as event name, log type, module, name, [other args...]
<span class="cstat-no" title="statement not covered" >        var allArgs = _.toArray(args),</span>
            emitFn = Log.emit || Log.trigger; // NodeJS/server=emit, Backbone/browser=trigger
<span class="cstat-no" title="statement not covered" >        allArgs.splice(0, 1, eventName, type, module, name);</span>
<span class="cstat-no" title="statement not covered" >        emitFn.apply(Log, allArgs);</span>
      }
    }
&nbsp;
...
&nbsp;
  ...
  */
  Log.console = <span class="fstat-no" title="function not covered" >function(type, module, name) {</span>
&nbsp;
    // Build the string to log, in log4js format
<span class="cstat-no" title="statement not covered" >    var nowStr = (new Date()).toJSON(),</span>
...
<span class="cstat-no" title="statement not covered" >      args = [name];</span>
    }
    else {
      // Add the log entry name
<span class="cstat-no" title="statement not covered" >      logStr += '.' + name;</span>
    }
&nbsp;
    // If the output is simple, just print it.  Otherwise JSON.stringify it.
<span class="cstat-no" title="statement not covered" >    logStr += ' - ';</span>
<span class="cstat-no" title="statement not covered" >    if (args.length === 1 &amp;&amp; typeof args[0] === 'string') {</span>
<span class="cstat-no" title="statement not covered" >      logStr += args[0];</span>
    }
    else {
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        logStr += JSON.stringify(args);</span>
      } catch(e) {
<span class="cstat-no" title="statement not covered" >        logStr += Monitor.stringify(args);</span>
      }
    }
&nbsp;
    // Send to the console - Log or error
<span class="cstat-no" title="statement not covered" >    if (type === 'error' || type === 'fatal') {</span>
<span class="cstat-no" title="statement not covered" >      console.error(logStr);</span>
    }
    else {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (pattern) {
