...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-monitor/node_modules/monitor/lib/probes/ProcessProbe.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-monitor/node_modules/monitor/lib/probes/ProcessProbe.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-monitor/node_modules/monitor/lib/probes/</a> &#187; ProcessProbe.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// ProcessProbe.js (c) 2010-2014 Loren West and other contributors
...
<span class="cstat-no" title="statement not covered" >      if (process.uptime) {<span class="cstat-no" title="statement not covered" >attrs.uptime = process.uptime();}</span></span>
<span class="cstat-no" title="statement not covered" >      if (process.versions) {<span class="cstat-no" title="statement not covered" >attrs.versions = process.versions;}</span></span>
<span class="cstat-no" title="statement not covered" >      if (process.arch) {<span class="cstat-no" title="statement not covered" >attrs.arch = process.arch;}</span></span>
<span class="cstat-no" title="statement not covered" >      t.set(attrs);</span>
    }
  });
&nbsp;
}(this));
